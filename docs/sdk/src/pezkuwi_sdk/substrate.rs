...
//! through which Pezkuwi can be utilized is by building "parachains", blockchains that are
//! connected to Pezkuwi's shared security.
//!
//! To build a parachain, one could use [Cumulus](crate::pezkuwi_sdk::cumulus), the library on
//! top of Substrate, empowering any substrate-based chain to be a Pezkuwi parachain.
//!
//! ## Where To Go Next?
//!
