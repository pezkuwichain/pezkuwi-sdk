...
//! for Substrate based chains such as Pezkuwi, Kusama and a growing number of parachains and
...
//!
//! You can read more about security and risks in [SECURITY.md](./SECURITY.md) and in the [Pezkuwi Wiki](https://wiki.pezkuwi.network/docs/learn-account-generation).
//!
//! ---
//!
