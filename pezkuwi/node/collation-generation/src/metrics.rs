		...
		let metrics = MetricsInner {
			collations_generated_total: prometheus::register(
				prometheus::Counter::new(
					"pezkuwi_parachain_collations_generated_total",
			...
			new_activation: prometheus::register(
				prometheus::Histogram::with_opts(prometheus::HistogramOpts::new(
					"pezkuwi_parachain_collation_generation_new_activations",
			...
			submit_collation: prometheus::register(
				prometheus::Histogram::with_opts(prometheus::HistogramOpts::new(
					"pezkuwi_parachain_collation_generation_submit_collation",
