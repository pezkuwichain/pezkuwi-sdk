...
use pezkuwi_runtime_parachains::paras::{ParaGenesisArgs, ParaKind};
use pezkuwi_service::{
...
pub fn new_full<OverseerGenerator: OverseerGen>(
	...
	match network_backend {
		sc_network::config::NetworkBackendType::Libp2p =>
			pezkuwi_service::new_full::<_, sc_network::NetworkWorker<_, _>>(
				config,
		...
		sc_network::config::NetworkBackendType::Litep2p =>
			pezkuwi_service::new_full::<_, sc_network::Litep2pNetworkBackend>(
				config,
				pezkuwi_service::NewFullParams {
					is_parachain_node,
					enable_beefy: true,
