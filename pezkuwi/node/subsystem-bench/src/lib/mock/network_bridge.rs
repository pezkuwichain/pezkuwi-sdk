...
use pezkuwi_node_network_protocol::Versioned;
						...
						match message {
							NetworkMessage::MessageFromPeer(peer_id, message) => match message {
								Versioned::V3(
									...
									ctx.send_message(
										BitfieldDistributionMessage::NetworkBridgeUpdate(NetworkBridgeEvent::PeerMessage(peer_id, pezkuwi_node_network_protocol::Versioned::V3(bitfield)))
									).await;
								},
								Versioned::V3(
									...
									if self.approval_voting_parallel_enabled {
										ctx.send_message(
											ApprovalVotingParallelMessage::NetworkBridgeUpdate(NetworkBridgeEvent::PeerMessage(peer_id, pezkuwi_node_network_protocol::Versioned::V3(msg)))
										).await;
									} else {
										ctx.send_message(
											ApprovalDistributionMessage::NetworkBridgeUpdate(NetworkBridgeEvent::PeerMessage(peer_id, pezkuwi_node_network_protocol::Versioned::V3(msg)))
										).await;
									}
								}
								Versioned::V3(
									...
									ctx.send_message(
										StatementDistributionMessage::NetworkBridgeUpdate(NetworkBridgeEvent::PeerMessage(peer_id, pezkuwi_node_network_protocol::Versioned::V3(msg)))
									).await;
								}
								_ => {
