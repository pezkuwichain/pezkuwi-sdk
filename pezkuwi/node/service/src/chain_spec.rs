...
/// JSON-based chain specs (for mainnet chains)
...
/// PezkuwiChain local testnet config (2 validators: Alice + Bob)
/// Uses preset: "local_testnet"
#[cfg(feature = "pezkuwi-native")]
...
/// PezkuwiChain alfa testnet config (4 validators: Alice + Bob + Charlie + Dave)
/// Uses preset: "alfa_testnet"
#[cfg(feature = "pezkuwi-native")]
pub fn pezkuwichain_alfa_testnet_config() -> Result<PezkuwiChainSpec, String> {
	Ok(PezkuwiChainSpec::builder(
		pezkuwi_runtime::WASM_BINARY.ok_or("Pezkuwi alfa testnet wasm not available")?,
		Default::default(),
	)
	.with_name("PezkuwiChain Alfa Testnet")
	.with_id("pezkuwichain_alfa_testnet")
	.with_chain_type(ChainType::Development)
	.with_genesis_config_preset_name("alfa_testnet")
	.with_protocol_id("pezkuwi")
	.with_properties(pezkuwi_properties())
	.build())
}

/// PezkuwiChain beta testnet config (8 validators with test seeds)
/// Uses preset: "beta_testnet"
#[cfg(feature = "pezkuwi-native")]
...
/// PezkuwiChain staging config (20 validators, real keys to be added)
/// Uses preset: "staging"
#[cfg(feature = "pezkuwi-native")]
...
/// PezkuwiChain production config (100 validators, real keys to be added)
/// Uses preset: "production"
#[cfg(feature = "pezkuwi-native")]
...
/// PezkuwiChain real testnet config - DEPRECATED, use beta_testnet
#[cfg(feature = "pezkuwi-native")]
pub fn pezkuwichain_real_testnet_config() -> Result<PezkuwiChainSpec, String> {
	// Redirect to beta testnet
	pezkuwichain_beta_testnet_config()
}