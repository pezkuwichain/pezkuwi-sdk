		...
		let metrics = MetricsInner {
			assignments_imported_total: prometheus::register(
				prometheus::CounterVec::new(
					prometheus::Opts::new(
						"pezkuwi_parachain_assignments_imported_total",
			...
			approvals_imported_total: prometheus::register(
				prometheus::Counter::new(
					"pezkuwi_parachain_approvals_imported_total",
			...
			unified_with_peer_total: prometheus::register(
				prometheus::Counter::new(
					"pezkuwi_parachain_unified_with_peer_total",
			...
			aggression_l1_messages_total: prometheus::register(
				prometheus::Counter::new(
					"pezkuwi_parachain_approval_distribution_aggression_l1_messages_total",
			...
			aggression_l2_messages_total: prometheus::register(
				prometheus::Counter::new(
					"pezkuwi_parachain_approval_distribution_aggression_l2_messages_total",
			...
			time_unify_with_peer: prometheus::register(
				prometheus::Histogram::with_opts(
					prometheus::HistogramOpts::new(
						"pezkuwi_parachain_time_unify_with_peer",
			...
			time_import_pending_now_known: prometheus::register(
				prometheus::Histogram::with_opts(prometheus::HistogramOpts::new(
					"pezkuwi_parachain_time_import_pending_now_known",
			...
			assignments_received_result: prometheus::register(
				prometheus::CounterVec::new(
					prometheus::Opts::new(
						"pezkuwi_parachain_assignments_received_result",
			...
			approvals_received_result: prometheus::register(
				prometheus::CounterVec::new(
					prometheus::Opts::new(
						"pezkuwi_parachain_approvals_received_result",
