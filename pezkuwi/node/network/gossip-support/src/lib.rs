	...
	AD: AuthorityDiscovery,
{
	...
	// `pezkuwi_node_is_parachain_validator` metrics accordingly.
	...
	fn check_connectivity(&mut self) {
		...
		// https://github.com/paritytech/pezkuwi/issues/3921
...
///
/// [web3]: https://research.web3.foundation/en/latest/pezkuwi/networking/3-avail-valid.html#topology
async fn update_gossip_topology(
	...
	let random_seed = {
		...
		// TODO https://github.com/paritytech/pezkuwi/issues/5316:
