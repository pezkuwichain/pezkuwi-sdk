		...
		let metrics = MetricsInner {
			...
			connected_events: prometheus::register(
				prometheus::CounterVec::new(
					prometheus::Opts::new(
						"pezkuwi_parachain_peer_connect_events_total",
			...
			disconnected_events: prometheus::register(
				prometheus::CounterVec::new(
					prometheus::Opts::new(
						"pezkuwi_parachain_peer_disconnect_events_total",
			...
			desired_peer_count: prometheus::register(
				prometheus::GaugeVec::new(
					prometheus::Opts::new(
						"pezkuwi_parachain_desired_peer_count",
			...
			report_events: prometheus::register(
				prometheus::Counter::new(
					"pezkuwi_parachain_network_report_events_total",
			...
			notifications_received: prometheus::register(
				prometheus::CounterVec::new(
					prometheus::Opts::new(
						"pezkuwi_parachain_notifications_received_total",
			...
			notifications_sent: prometheus::register(
				prometheus::CounterVec::new(
					prometheus::Opts::new(
						"pezkuwi_parachain_notifications_sent_total",
			...
			bytes_received: prometheus::register(
				prometheus::CounterVec::new(
					prometheus::Opts::new(
						"pezkuwi_parachain_notification_bytes_received_total",
			...
			bytes_sent: prometheus::register(
				prometheus::CounterVec::new(
					prometheus::Opts::new(
						"pezkuwi_parachain_notification_bytes_sent_total",
			...
			messages_sent: prometheus::register(
				prometheus::CounterVec::new(
					prometheus::Opts::new(
						"pezkuwi_parachain_messages_sent_total",
			...
			rx_delayed_processing: prometheus::register(
				prometheus::Histogram::with_opts(
					prometheus::HistogramOpts::new(
						"pezkuwi_parachain_network_bridge_rx_delayed",
			...
			rx_delayed_processing_time: prometheus::register(
				prometheus::Histogram::with_opts(
					prometheus::HistogramOpts::new(
						"pezkuwi_parachain_network_bridge_rx_delayed_time",
