	...
	fn try_register(registry: &Registry) -> Result<Self, PrometheusError> {
		let metrics = MetricsInner {
			chunk_requests_issued: prometheus::register(
				CounterVec::new(
					Opts::new("pezkuwi_parachain_availability_recovery_chunk_requests_issued",
			...
			full_data_requests_issued: prometheus::register(
				Counter::new(
					"pezkuwi_parachain_availability_recovery_full_data_requests_issued",
			...
			recovered_bytes_total: prometheus::register(
				Counter::new(
					"pezkuwi_parachain_availability_recovery_bytes_total",
					"Total number of bytes recovered",
				)?,
				registry,
			)?,
			chunk_requests_finished: prometheus::register(
				CounterVec::new(
					Opts::new(
						"pezkuwi_parachain_availability_recovery_chunk_requests_finished",
			...
			chunk_request_protocols: prometheus::register(
				CounterVec::new(
					Opts::new(
						"pezkuwi_parachain_availability_recovery_chunk_request_protocols",
			...
			full_data_requests_finished: prometheus::register(
				CounterVec::new(
					Opts::new(
						"pezkuwi_parachain_availability_recovery_full_data_requests_finished",
			...
			time_chunk_request: prometheus::register(
				prometheus::HistogramVec::new(prometheus::HistogramOpts::new(
					"pezkuwi_parachain_availability_recovery_time_chunk_request",
			...
			time_erasure_recovery: prometheus::register(
				prometheus::HistogramVec::new(prometheus::HistogramOpts::new(
					"pezkuwi_parachain_availability_recovery_time_erasure_recovery",
			...
			time_erasure_reconstruct: prometheus::register(
				prometheus::HistogramVec::new(prometheus::HistogramOpts::new(
					"pezkuwi_parachain_availability_recovery_time_erasure_reconstruct",
			...
			time_reencode_chunks: prometheus::register(
				prometheus::Histogram::with_opts(prometheus::HistogramOpts::new(
					"pezkuwi_parachain_availability_reencode_chunks",
			...
			time_full_recovery: prometheus::register(
				prometheus::Histogram::with_opts(prometheus::HistogramOpts::new(
					"pezkuwi_parachain_availability_recovery_time_total",
			...
			full_recoveries_finished: prometheus::register(
				CounterVec::new(
					Opts::new(
						"pezkuwi_parachain_availability_recovery_recoveries_finished",
			...
			full_recoveries_started: prometheus::register(
				Counter::new(
					"pezkuwi_parachain_availability_recovery_recoveries_started",
