		...
		let metrics = MetricsInner {
			imported_candidates_total: prometheus::register(
				prometheus::Counter::new(
					"pezkuwi_parachain_imported_candidates_total",
			...
			assignments_produced: prometheus::register(
				prometheus::Histogram::with_opts(
					prometheus::HistogramOpts::new(
						"pezkuwi_parachain_assignments_produced",
			...
			approvals_produced_total: prometheus::register(
				prometheus::CounterVec::new(
					prometheus::Opts::new(
						"pezkuwi_parachain_approvals_produced_total",
			...
			no_shows_total: prometheus::register(
				prometheus::Counter::new(
					"pezkuwi_parachain_approvals_no_shows_total",
			...
			observed_no_shows: prometheus::register(
				prometheus::Counter::new(
					"pezkuwi_parachain_approvals_observed_no_shows_total",
			...
			wakeups_triggered_total: prometheus::register(
				prometheus::Counter::new(
					"pezkuwi_parachain_approvals_wakeups_total",
			...
			candidate_approval_time_ticks: prometheus::register(
				prometheus::Histogram::with_opts(
					prometheus::HistogramOpts::new(
						"pezkuwi_parachain_approvals_candidate_approval_time_ticks",
			...
			coalesced_approvals_buckets: prometheus::register(
				prometheus::Histogram::with_opts(
					prometheus::HistogramOpts::new(
						"pezkuwi_parachain_approvals_coalesced_approvals_buckets",
			...
			coalesced_approvals_delay: prometheus::register(
				prometheus::Histogram::with_opts(
					prometheus::HistogramOpts::new(
						"pezkuwi_parachain_approvals_coalescing_delay",
			...
			approved_by_one_third: prometheus::register(
				prometheus::Counter::new(
					"pezkuwi_parachain_approved_by_one_third",
			...
			block_approval_time_ticks: prometheus::register(
				prometheus::Histogram::with_opts(
					prometheus::HistogramOpts::new(
						"pezkuwi_parachain_approvals_blockapproval_time_ticks",
			...
			time_db_transaction: prometheus::register(
				prometheus::Histogram::with_opts(
					prometheus::HistogramOpts::new(
						"pezkuwi_parachain_time_approval_db_transaction",
			...
			time_recover_and_approve: prometheus::register(
				prometheus::Histogram::with_opts(
					prometheus::HistogramOpts::new(
						"pezkuwi_parachain_time_recover_and_approve",
			...
			candidate_signatures_requests_total: prometheus::register(
				prometheus::Counter::new(
					"pezkuwi_parachain_approval_candidate_signatures_requests_total",
			...
			unapproved_candidates_in_unfinalized_chain: prometheus::register(
				prometheus::Gauge::new(
					"pezkuwi_parachain_approval_unapproved_candidates_in_unfinalized_chain",
			...
			assignments_gathering_time_by_stage: prometheus::register(
				prometheus::HistogramVec::new(
					prometheus::HistogramOpts::new(
						"pezkuwi_parachain_assignments_gather_time_by_stage_ms",
...
// 	https://github.com/paritytech/pezkuwi/issues/3311
//
