...
use core::panic;
use pezkuwi_parachain_primitives::primitives::{HeadData as GenericHeadData, ValidationResult};

#[no_mangle]
pub extern "C" fn validate_block(params: *const u8, len: usize) -> u64 {
	let params = unsafe { pezkuwi_parachain_primitives::load_params(params, len) };
	let parent_head =
	...
	pezkuwi_parachain_primitives::write_result(&ValidationResult {
