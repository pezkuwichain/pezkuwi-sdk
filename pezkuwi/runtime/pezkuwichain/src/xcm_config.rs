...
use pezkuwichain_constants::{currency::CENTS, system_parachain::*};
...
impl xcm_executor::Config for XcmConfig {
	...
	>;
	type Trader =
		UsingComponents<frame_support::weights::ConstantMultiplier<Balance, TransactionByteFee>, TokenLocation, AccountId, Balances, ToAuthor<Runtime>>;
