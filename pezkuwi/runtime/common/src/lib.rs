...
//! Common runtime code for the Relay Chain, e.g. Rococo, Westend, Pezkuwi, Kusama ...
...
/// <https://research.web3.foundation/Pezkuwi/overview/token-economics#2-slow-adjusting-mechanism>
