...
pub mod pallet {
	...
	impl<T: Config> Pallet<T> {
		/// Make a claim to collect your HEZs.
		///
		...
		/// Mint a new claim to collect HEZs.
		///
		/// The dispatch origin for this call must be _Root_.
		///
		/// Parameters:
		/// - `who`: The Ethereum address allowed to collect this claim.
		/// - `value`: The number of HEZs that will be claimed.
		/// - `vesting_schedule`: An optional vesting schedule for these HEZs.
		///
		/// <weight>
		/// The weight of this call is invariant over the input parameters.
		...
		/// Make a claim to collect your HEZs by signing a statement.
		///
		/// The dispatch origin for this call must be _None_.
		///
		/// Unsigned Validation:
