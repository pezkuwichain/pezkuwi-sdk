...
//! Autogenerated weights for `pezkuwi_runtime_parachains::inclusion`
//!
...
// --pallet=pezkuwi_runtime_parachains::inclusion
...
/// Weight functions for `pezkuwi_runtime_parachains::inclusion`.
pub struct WeightInfo<T>(PhantomData<T>);
impl<T: frame_system::Config> pezkuwi_runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
