...
//! Autogenerated weights for `pezkuwi_runtime_parachains::hrmp`
//!
...
// --pallet=pezkuwi_runtime_parachains::hrmp
...
/// Weight functions for `pezkuwi_runtime_parachains::hrmp`.
pub struct WeightInfo<T>(PhantomData<T>);
impl<T: frame_system::Config> pezkuwi_runtime_parachains::hrmp::WeightInfo for WeightInfo<T> {
