...
//! Autogenerated weights for `pezkuwi_runtime_parachains::coretime`
//!
...
// --pallet=pezkuwi_runtime_parachains::coretime
...
/// Weight functions for `pezkuwi_runtime_parachains::coretime`.
pub struct WeightInfo<T>(PhantomData<T>);
impl<T: frame_system::Config> pezkuwi_runtime_parachains::coretime::WeightInfo for WeightInfo<T> {
