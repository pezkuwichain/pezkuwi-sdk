...
//! Autogenerated weights for `pezkuwi_runtime_parachains::disputes`
//!
...
// --pallet=pezkuwi_runtime_parachains::disputes
...
/// Weight functions for `pezkuwi_runtime_parachains::disputes`.
pub struct WeightInfo<T>(PhantomData<T>);
impl<T: frame_system::Config> pezkuwi_runtime_parachains::disputes::WeightInfo for WeightInfo<T> {
