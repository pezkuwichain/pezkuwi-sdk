...
//! Autogenerated weights for `pezkuwi_runtime_parachains::configuration`
//!
...
// --pallet=pezkuwi_runtime_parachains::configuration
...
/// Weight functions for `pezkuwi_runtime_parachains::configuration`.
pub struct WeightInfo<T>(PhantomData<T>);
impl<T: frame_system::Config> pezkuwi_runtime_parachains::configuration::WeightInfo for WeightInfo<T> {
