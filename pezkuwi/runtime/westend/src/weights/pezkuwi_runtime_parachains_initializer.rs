...
//! Autogenerated weights for `pezkuwi_runtime_parachains::initializer`
//!
...
// --pallet=pezkuwi_runtime_parachains::initializer
...
/// Weight functions for `pezkuwi_runtime_parachains::initializer`.
pub struct WeightInfo<T>(PhantomData<T>);
impl<T: frame_system::Config> pezkuwi_runtime_parachains::initializer::WeightInfo for WeightInfo<T> {
