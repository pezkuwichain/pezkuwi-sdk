...
//! Autogenerated weights for `pezkuwi_runtime_parachains::paras`
//!
...
// --pallet=pezkuwi_runtime_parachains::paras
...
/// Weight functions for `pezkuwi_runtime_parachains::paras`.
pub struct WeightInfo<T>(PhantomData<T>);
impl<T: frame_system::Config> pezkuwi_runtime_parachains::paras::WeightInfo for WeightInfo<T> {
