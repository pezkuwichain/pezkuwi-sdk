...
//! Autogenerated weights for `pezkuwi_runtime_parachains::disputes::slashing`
//!
...
// --pallet=pezkuwi_runtime_parachains::disputes::slashing
// --header=/__w/pezkuwi-sdk/pezkuwi-sdk/pezkuwi/file_header.txt
// --output=./pezkuwi/runtime/westend/src/weights
...
/// Weight functions for `pezkuwi_runtime_parachains::disputes::slashing`.
pub struct WeightInfo<T>(PhantomData<T>);
impl<T: frame_system::Config> pezkuwi_runtime_parachains::disputes::slashing::WeightInfo for WeightInfo<T> {
