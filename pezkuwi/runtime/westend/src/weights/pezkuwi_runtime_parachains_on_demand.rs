...
//! Autogenerated weights for `pezkuwi_runtime_parachains::on_demand`
//!
...
// --pallet=pezkuwi_runtime_parachains::on_demand
...
/// Weight functions for `pezkuwi_runtime_parachains::on_demand`.
pub struct WeightInfo<T>(PhantomData<T>);
impl<T: frame_system::Config> pezkuwi_runtime_parachains::on_demand::WeightInfo for WeightInfo<T> {
