...
//! Autogenerated weights for `pezkuwi_runtime_parachains::paras_inherent`
//!
...
// --pallet=pezkuwi_runtime_parachains::paras_inherent
...
/// Weight functions for `pezkuwi_runtime_parachains::paras_inherent`.
pub struct WeightInfo<T>(PhantomData<T>);
impl<T: frame_system::Config> pezkuwi_runtime_parachains::paras_inherent::WeightInfo for WeightInfo<T> {
