...
impl parachains_hrmp::Config for Runtime {
	...
	type WeightInfo = weights::pezkuwi_runtime_parachains_hrmp::WeightInfo<Self>;
}
...
impl parachains_slashing::Config for Runtime {
	...
	type HandleReports = parachains_slashing::SlashingReportHandler<
		...
		ReportLongevity,
	>;
	type WeightInfo = weights::pezkuwi_runtime_parachains_disputes_slashing::WeightInfo<Runtime>;
...
mod benches {
	frame_benchmarking::define_benchmarks!(
		...
		[pezkuwi_runtime_parachains::disputes::slashing, ParasSlashing]
...
sp_api::impl_runtime_apis! {
	...
	impl frame_benchmarking::Benchmark<Block> for Runtime {
		...
		> {
			...
			impl pezkuwi_runtime_parachains::disputes::slashing::benchmarking::Config for Runtime {}
