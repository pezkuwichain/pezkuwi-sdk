...
use pezkuwi_runtime_parachains::reward_points::RewardValidatorsWithEraPoints;
...
impl onchain::Config for OnChainSeqPhragmen {
	type System = Runtime;
	type Solver =
		SequentialPhragmen<AccountId, pezkuwi_runtime_common::elections::OnChainAccuracy>;
