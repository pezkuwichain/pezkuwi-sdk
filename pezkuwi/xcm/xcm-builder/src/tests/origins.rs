...
fn universal_origin_should_work() {
	...
	// Parachain 2 may represent Pezkuwi to us
	add_universal_alias(Parachain(2), Pezkuwi);
...
fn export_message_should_work() {
	...
	// Local parachain #1 issues a transfer asset on Pezkuwi Relay-chain, transferring 100 Planck
	// to Pezkuwi parachain #2.
