...
//! `GlobalConsensus(Pezkuwi)/Parachain(1000)`.
//!
//! ## Assets
//!
...
//! The asset hub system parachain in Pezkuwi, for example, holds a lot of assets.
...
//! `Parachain(1000)/PalletInstance(53)/GeneralIndex(1984)`, when seen from the Pezkuwi relaychain.
