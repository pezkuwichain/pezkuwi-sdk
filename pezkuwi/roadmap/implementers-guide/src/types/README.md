...
digraph {
    ...
    Id [label="pezkuwi_parachain_primitives::primitives::Id"]
    ...
    CandidateCommitments:upward_messages -> "pezkuwi_parachain_primitives::primitives::UpwardMessage":w
    ...
    CandidateCommitments:horizontal_messages -> "pezkuwi_parachain_primitives::primitives::Id":w
    CandidateCommitments:new_validation_code -> "pezkuwi_parachain_primitives::primitives::ValidationCode":w
    ...
    PoV:block_data -> "pezkuwi_parachain_primitives::primitives::BlockData":w
    ...
    HeadData [label = "pezkuwi_parachain_primitives::primitives::HeadData"]
...
These data types are defined in `pezkuwi/parachain/src/primitives.rs`:
