...
use bridge_hub_rococo_runtime::{
	...
	ExistentialDeposit, ParachainSystem, PezkuwiXcm, Runtime, RuntimeCall, RuntimeEvent,
...
mod bridge_hub_westend_tests {
	...
	fn handle_export_message_from_system_parachain_add_to_outbound_queue_works() {
		...
		>(
			...
			|| {
				PezkuwiXcm::force_xcm_version(RuntimeOrigin::root(), Box::new(BridgeHubWestendLocation::get()), XCM_VERSION).expect("version saved!");
...
mod bridge_hub_bulletin_tests {
	...
	use bridge_to_bulletin_config::{
		...
		WithRococoBulletinMessagesInstance, XcmOverPezkuwiBulletinInstance,
	};
	...
	fn handle_export_message_from_system_parachain_add_to_outbound_queue_works() {
		...
		>(
			...
			None,
			|| {
				PezkuwiXcm::force_xcm_version(RuntimeOrigin::root(), Box::new(RococoBulletinGlobalConsensusNetworkLocation::get()), XCM_VERSION).expect("version saved!");
