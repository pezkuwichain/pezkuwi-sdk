...
fn account_on_sibling_syschain_aliases_into_same_local_account() {
	...
	test_cross_chain_alias!(
		vec![
			...
			(AssetHubWestend, CoretimeWestend, TELEPORT_FEES, ALLOWED),
			// between BH and Coretime: allowed
			(BridgeHubWestend, CoretimeWestend, TELEPORT_FEES, ALLOWED),
			// between Collectives and Coretime: allowed
			(CollectivesWestend, CoretimeWestend, TELEPORT_FEES, ALLOWED),
...
fn account_on_sibling_syschain_cannot_alias_into_different_local_account() {
	...
	test_cross_chain_alias!(
		vec![
			...
			(CollectivesWestend, CoretimeWestend, TELEPORT_FEES, DENIED),
...
fn authorized_cross_chain_aliases() {
	...
	CoretimeWestend::execute_with(|| {
		...
		assert_ok!(<CoretimeWestend as CoretimeWestendPallet>::PezkuwiXcm::add_authorized_alias(
	...
	CoretimeWestend::execute_with(|| {
		...
		assert_ok!(
			<CoretimeWestend as CoretimeWestendPallet>::PezkuwiXcm::remove_all_authorized_aliases(
				<CoretimeWestend as Chain>::RuntimeOrigin::signed(target.clone())
			)
		);
	});
