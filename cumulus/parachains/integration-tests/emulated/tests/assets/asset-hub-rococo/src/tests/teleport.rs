...
fn system_para_limited_teleport_assets(t: SystemParaToRelayTest) -> DispatchResult {
	<AssetHubRococo as AssetHubRococoPallet>::PezkuwiXcm::limited_teleport_assets(
		t.signed_origin,
		bx!(t.args.dest.into()),
...
fn system_para_to_para_transfer_assets(t: SystemParaToParaTest) -> DispatchResult {
	<AssetHubRococo as AssetHubRococoPallet>::PezkuwiXcm::transfer_assets(
		t.signed_origin,
		bx!(t.args.dest.into()),
		bx!(t.args.beneficiary.into()),
		bx!(t.args.assets.into()),
...
fn teleport_to_untrusted_chain_fails() {
	...
	// this should fail
	AssetHubRococo::execute_with(|| {
		let result = <AssetHubRococo as AssetHubRococoPallet>::PezkuwiXcm::transfer_assets_using_type_and_then(
			signed_origin.clone(),
	...
	AssetHubRococo::execute_with(|| {
		...
		let result = <AssetHubRococo as AssetHubRococoPallet>::PezkuwiXcm::execute(
			signed_origin,
