...
/// [`ValidationParams`](pezkuwi_parachain_primitives::primitives::ValidationParams), but a little
...
/// [`ValidationParams`](pezkuwi_parachain_primitives::primitives::ValidationParams) to have the
/// same SCALE encoding.
#[derive(codec::Decode)]
